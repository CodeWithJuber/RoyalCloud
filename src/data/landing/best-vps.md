...
title: Best VPS
metadata:
  title: Best VPS Hosting - Fast SSD VPS Hosting
  description: >-
    Order your Best VPS and choose the software version you prefer. Order now and experience our SSD VPS speed. Deploy
    now!
...
sections:
  - type: hero
    variant: gradient
    eyebrow: Best VPS
    title: Best VPS on <em>Pure SSD</em> — Built for Speed
    subtitle: >-
      Order your Best VPS and choose the software version you prefer. Order now and experience our SSD VPS speed. Deploy
      now!
    primaryCta:
  ...
  - type: pricing
    ...
    title: Choose your best vps plan
    showToggle: true
    note: 30-day money-back guarantee · Instant setup · Free migration.
  - type: features
    eyebrow: Why Royal Clouds
    title: Everything your best vps needs
    columns: 3
    items:
      - icon: cpu
        title: KVM Virtualization
        text: True hardware isolation — your best vps gets dedicated resources that are never oversold.
      - icon: bolt
  ...
  - type: faq
    eyebrow: FAQ
    title: Best VPS — common questions
    source: inline
    items:
      - q: What do I get with Best VPS?
        a: >-
      ...
      - q: Can I upgrade later?
        a: >-
          ...
          change.
  - type: cta
    title: Launch your best vps today
