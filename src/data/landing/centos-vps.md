...
sections:
  - type: hero
    variant: gradient
    title: CentOS VPS with full root and <em>RHEL-compatible</em> stability
    subtitle: >-
  ...
  - type: features
    ...
    items:
      - icon: cpu
        ...
        text: True hardware isolation, your centos vps gets dedicated resources that are never oversold.
      - icon: bolt
