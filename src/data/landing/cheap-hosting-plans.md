...
metadata:
  ...
  description: >-
    Royal Clouds Providing Cheapest Hosting Plans with SSD Web Hosting. Try Our Any Cheap SSD Web Hosting Plans India
    For Fast & Secure Hosting.
  ...
  - type: features
    ...
    items:
      - icon: bolt
        ...
        text: Our cheap hosting plans runs on LiteSpeed web servers with pure SSD storage — pages load up to 15x faster.
      - icon: apps
