...
title: Cheap KVM VPS
metadata:
  title: Cheap KVM VPS - Cheap VPS Hosting With SSD Storage India
  description: >-
    Buy Cheap KVM VPS : Royal clouds providing Cheap kvm vps Hosting with Fast SSD DDos Protection KVM VPS in India, Try
    Our KVM VPS Hosting.
...
sections:
  - type: hero
    variant: gradient
    eyebrow: Cheap KVM VPS
    title: Cheap KVM VPS on <em>Pure SSD</em> — Built for Speed
    subtitle: >-
      Buy Cheap KVM VPS : Royal clouds providing Cheap kvm vps Hosting with Fast SSD DDos Protection KVM VPS in India,
      Try Our KVM VPS Hosting.
    primaryCta:
      text: Get Started
  ...
  - type: pricing
    ...
    title: Choose your cheap kvm vps plan
    showToggle: true
    note: 30-day money-back guarantee · Instant setup · Free migration.
  - type: features
    eyebrow: Why Royal Clouds
    title: Everything your cheap kvm vps needs
    columns: 3
    items:
      - icon: cpu
        title: KVM Virtualization
        text: True hardware isolation — your cheap kvm vps gets dedicated resources that are never oversold.
      - icon: bolt
  ...
  - type: faq
    eyebrow: FAQ
    title: Cheap KVM VPS — common questions
    source: inline
    items:
      - q: What do I get with Cheap KVM VPS?
        a: >-
      ...
      - q: Can I upgrade later?
        a: >-
          ...
          change.
  - type: cta
    title: Launch your cheap kvm vps today
