...
metadata:
  title: Cheap Shared Hosting - Cheap SSD Shared Web Hosting India
  description: >-
    Buy Cheap Shared Hosting From RoyalClouds Web Hosting Company. Try Our Fast & Cheap SSD Shared Web Hosting Plans in
    India - Cheap Shared Web Hosting
...
sections:
  - type: hero
    variant: gradient
    eyebrow: Cheap Shared Hosting
    title: Cheap Shared Hosting on <em>Pure SSD</em> — Built for Speed
    subtitle: >-
      Buy Cheap Shared Hosting From RoyalClouds Web Hosting Company. Try Our Fast & Cheap SSD Shared Web Hosting Plans
      in India - Cheap Shared Web Hosting
    primaryCta:
      text: Get Started
  ...
  - type: pricing
    ...
    title: Choose your cheap shared hosting plan
    showToggle: true
    note: 30-day money-back guarantee · Instant setup · Free migration.
  - type: features
    eyebrow: Why Royal Clouds
    title: Everything your cheap shared hosting needs
    columns: 3
    items:
      - icon: bolt
        title: LiteSpeed + LSCache
        text: Our cheap shared hosting runs on LiteSpeed web servers with pure SSD storage — pages load up to 15x faster.
      - icon: apps
  ...
  - type: faq
    eyebrow: FAQ
    title: Cheap Shared Hosting — common questions
    source: inline
    items:
      - q: What is included with cheap shared hosting?
        a: >-
  ...
  - type: cta
    title: Launch your cheap shared hosting today
