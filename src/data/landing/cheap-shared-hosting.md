...
metadata:
  ...
  description: >-
    Buy Cheap Shared Hosting From RoyalClouds Web Hosting Company. Try Our Fast & Cheap SSD Shared Web Hosting
    Plans in India - Cheap Shared Web Hosting
  ...
  - type: features
    ...
    items:
      - icon: bolt
        ...
        text: >-
          Our cheap shared hosting runs on LiteSpeed web servers with pure SSD storage — pages load up to 15x
          faster.
      - icon: apps
