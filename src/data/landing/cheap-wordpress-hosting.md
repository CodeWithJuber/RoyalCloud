---
title: Cheap Wordpress Hosting
metadata:
  title: Cheap WordPress Hosting - Cheapest Hosting For WordPress in India
  description: >-
...
sections:
  ...
  - type: features
    ...
    title: Everything your cheap wordpress hosting needs
    columns: 3
    items:
      - icon: wordpress
        title: Optimized for WordPress
        text: >-
          Our cheap wordpress hosting stack is tuned end-to-end for WordPress — LiteSpeed, LSCache and PHP workers
          configured for you.
      - icon: refresh
        title: Auto Updates
