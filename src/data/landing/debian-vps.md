...
title: Debian VPS
metadata:
  title: Fast Debian VPS Hosting - Best Debian SSD VPS Hosting India
  description: >-
    Order your Debian VPS and choose the software version you prefer. Order now and experience our SSD Debian VPS
...
sections:
  - type: hero
    variant: gradient
    eyebrow: Debian VPS
    title: Debian VPS on <em>Pure SSD</em> — Built for Speed
    subtitle: >-
      Debian pre-installed on premium KVM VPS — pure SSD RAID-10 storage, full root access, instant setup, DDoS
  ...
  - type: pricing
    ...
    title: Choose your debian vps plan
    showToggle: true
    note: 30-day money-back guarantee · Instant setup · Free migration.
  - type: features
    eyebrow: Why Royal Clouds
    title: Everything your debian vps needs
    columns: 3
    items:
      - icon: cpu
        title: KVM Virtualization
        text: True hardware isolation — your debian vps gets dedicated resources that are never oversold.
      - icon: bolt
        title: Pure SSD RAID-10
        text: Enterprise SSDs in RAID-10 deliver up to 15x faster disk I/O than HDD servers.
      - icon: terminal
        title: Debian Pre-Installed
        text: Deploy Debian in one click — or reload to any other Linux distribution from the panel, any time.
      - icon: shield
  ...
  - type: faq
    eyebrow: FAQ
    title: Debian VPS — common questions
    source: inline
    items:
      - q: What do I get with Debian VPS?
        a: >-
      ...
      - q: Which Debian versions are available?
        a: >-
          We keep current Debian releases ready to deploy, and you can reload your VPS with any supported version from
      ...
      - q: Can I upgrade later?
        a: >-
          ...
          change.
  - type: cta
    title: Launch your debian vps today
