...
title: Dedicated VPS
metadata:
  title: Cheap Dedicated VPS Services India - SSD Dedicated VPS
  description: >-
    Cheap Dedicated VPS: Buy Dedicated VPS For Fast Website Loading on Affordable Price. Try Our Secure & Fast Linux VPS
    Hosting on Affordable Prices
...
sections:
  - type: hero
    ...
    title: Dedicated VPS on <em>Pure SSD</em> — Built for Speed
    subtitle: >-
      Cheap Dedicated VPS: Buy Dedicated VPS For Fast Website Loading on Affordable Price. Try Our Secure & Fast Linux
      VPS Hosting on Affordable Prices
    primaryCta:
      text: Get Started
  ...
  - type: pricing
    ...
    title: Choose your dedicated vps plan
    showToggle: true
    note: 30-day money-back guarantee · Instant setup · Free migration.
  - type: features
    eyebrow: Why Royal Clouds
    title: Everything your dedicated vps needs
    columns: 3
    items:
      - icon: cpu
        title: KVM Virtualization
        text: True hardware isolation — your dedicated vps gets dedicated resources that are never oversold.
      - icon: bolt
  ...
  - type: faq
    eyebrow: FAQ
    title: Dedicated VPS — common questions
    source: inline
    items:
      - q: What do I get with Dedicated VPS?
        a: >-
      ...
      - q: Can I upgrade later?
        a: >-
          ...
          change.
  - type: cta
    title: Launch your dedicated vps today
