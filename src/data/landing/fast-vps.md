...
title: Fast VPS
metadata:
  title: Fast VPS Hosting - Best SSD VPS Hosting
  description: >-
    Order your Fast VPS and choose the software version you prefer. Order now and experience our fast SSD VPS Hosting
    speed. Deploy now!
...
sections:
  - type: hero
    variant: gradient
    eyebrow: Fast VPS
    title: Fast VPS on <em>Pure SSD</em> — Built for Speed
    subtitle: >-
      Order your Fast VPS and choose the software version you prefer. Order now and experience our fast SSD VPS Hosting
      speed. Deploy now!
    primaryCta:
  ...
  - type: pricing
    ...
    title: Choose your fast vps plan
    showToggle: true
    note: 30-day money-back guarantee · Instant setup · Free migration.
  - type: features
    eyebrow: Why Royal Clouds
    title: Everything your fast vps needs
    columns: 3
    items:
      - icon: cpu
        title: KVM Virtualization
        text: True hardware isolation — your fast vps gets dedicated resources that are never oversold.
      - icon: bolt
  ...
  - type: faq
    eyebrow: FAQ
    title: Fast VPS — common questions
    source: inline
    items:
      - q: What do I get with Fast VPS?
        a: >-
      ...
      - q: Can I upgrade later?
        a: >-
          ...
          change.
  - type: cta
    title: Launch your fast vps today
