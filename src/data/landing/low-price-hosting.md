...
sections:
  - type: hero
    ...
    subtitle: >-
      Starter-friendly SSD hosting for blogs and small sites, with LiteSpeed caching, free cPanel & SSL, free
      migration and daily backups from day one.
    primaryCta:
      text: Get started
