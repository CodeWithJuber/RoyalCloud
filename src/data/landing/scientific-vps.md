...
metadata:
  ...
  description: >-
    Order your Scientific VPS and choose the software version you prefer. Order now and experience our SSD Scientific
...
sections:
  - type: hero
    variant: gradient
    eyebrow: Scientific VPS
    title: Scientific VPS on <em>Pure SSD</em> — Built for Speed
    subtitle: >-
      Scientific Linux pre-installed on premium KVM VPS — pure SSD RAID-10 storage, full root access, instant setup,
  ...
  - type: features
    ...
    items:
      ...
      - icon: terminal
        ...
        text: Deploy Scientific Linux in one click — or reload to any other Linux distribution from the panel, any time.
      - icon: shield
  ...
  - type: faq
    ...
    items:
      ...
      - q: Which Scientific Linux versions are available?
        a: >-
          We keep current Scientific Linux releases ready to deploy, and you can reload your VPS with any supported
