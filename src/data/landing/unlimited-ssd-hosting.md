...
sections:
  ...
  - type: features
    ...
    title: Everything your unlimited ssd hosting needs
    columns: 3
    items:
      - icon: bolt
        title: LiteSpeed + LSCache
        text: Our unlimited ssd hosting runs on LiteSpeed web servers with pure SSD storage — pages load up to 15x faster.
      - icon: apps
