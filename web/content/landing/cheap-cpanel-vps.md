...
metadata:
  ...
  description: >-
    Buy Cheap Cpanel VPS Hosting Server For Your Website or Blog. Royal Clouds Providing Fast, Secured &
    Cheapest Cpanel VPS Hosting Server in India. Starting @4$/M
...
sections:
  - type: hero
    variant: gradient
    title: Budget cPanel VPS with full root access
    subtitle: >-
      Affordable KVM VPS with cPanel and WHM preinstalled, so you manage sites, email and DNS from a familiar
      panel, backed by full root access, DDoS protection and friendly 24/7 support.
    primaryCta:
      text: Get started
