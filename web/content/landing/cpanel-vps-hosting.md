...
metadata:
  ...
  description: >-
    Cpanel VPS Hosting: Royal Clouds provide Best vps hosting with cpanel, cheap vps server price and managed
    vps hosting by professional
...
sections:
  - type: hero
    variant: gradient
    title: cPanel and WHM VPS with full root control
    subtitle: >-
      KVM VPS with cPanel and WHM preinstalled, so you manage sites, email and DNS from a familiar panel,
      backed by full root access, DDoS protection and friendly 24/7 support.
    primaryCta:
      text: Get started
