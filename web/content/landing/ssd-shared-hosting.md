...
metadata:
  title: SSD Shared Hosting Plans - Fast Linux Shared SSD Hosting
  description: >-
    Host your sites on fast SSD shared hosting with LiteSpeed, free cPanel & SSL, free migration and daily
    backups — reliable Linux shared hosting plans from Royal Clouds.
...
sections:
  ...
  - type: pricing
    ...
    title: Choose your ssd shared hosting plan
    showToggle: true
  ...
  - type: faq
    eyebrow: FAQ
    title: SSD Shared Hosting, common questions
    source: inline
    items:
      - q: What is included with ssd shared hosting?
        a: >-
  ...
  - type: cta
    title: Launch your ssd shared hosting today
